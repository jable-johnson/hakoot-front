<template>
  <nav class="bg-white shadow">
    ...
    <div v-show="showDropDownMenu" class="lg:hidden" id="mobile-menu">
  ...
  options = [
    {
      label: 'Profile',
      key: 'profile',
      icon: this.renderIcon(BaseIcon, 'user'),
    },
    {
      label: 'Edit Profile',
      key: 'editProfile',
      icon: this.renderIcon(BaseIcon, 'edit'),
    },
    {
      label: 'Logout',
      key: 'logout',
      icon: this.renderIcon(BaseIcon, 'logout'),
    },
  ];
  renderIcon(icon: any, name: string) {
    return () => {
