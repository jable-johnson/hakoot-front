<template>
  <div class="pt-3 bg-gray-900 lg:pb-14 lg:overflow-hidden">
            ...
            <div class="mt-10 sm:mt-12">
              <form action="#" class="sm:max-w-xl sm:mx-auto lg:mx-0">
                ...
                <p class="mt-3 text-sm text-gray-300 sm:mt-4">
                  ...
                  <a href="#" class="font-medium text-white">terms or service</a>.
                </p>
              </form>
            </div>
          </div>
            ...
            <div class="flex-1">
              ...
              <a href="#" class="block mt-2">
                ...
                <p class="mt-3 text-base text-gray-500">
                  ...
                  Adipisci tempora aut inventore optio animi., tempore temporibus quo laudantium.
                </p>
              </a>
            </div>
            <div class="mt-6 flex items-center">
          ...
          <div class="flex-1 bg-white p-6 flex flex-col justify-between">
            <div class="flex-1">
              ...
              <a href="#" class="block mt-2">
                ...
                <p class="mt-3 text-base text-gray-500">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint harum rerum voluptatem quo recusandae magni placeat saepe
    ...
    <div class="relative mx-auto max-w-md px-4 py-12 sm:max-w-7xl sm:px-6 sm:py-20 md:py-28 lg:px-8 lg:py-32">
      <div class="md:ml-auto md:w-1/2 md:pl-10">
        ...
        <p class="mt-3 text-lg text-gray-300">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Et, egestas tempus tellus etiam sed. Quam a scelerisque amet ullamcorper
          eu enim et fermentum, augue. Aliquet amet volutpat quisque ut interdum tincidunt duis.
        </p>
        <div class="mt-8">
